...
import { Resume } from "@/components/modules/TopMenu/Resume";
...
export function Controls({
	...
	return (
		<div id="top-menu-controls" className="hidden md:flex items-center gap-2">
			<Resume />
			<div
				id="top-menu-divider-0"
			...
			<Button
				...
				className="hover:bg-black/5 dark:hover:bg-white/5 font-medium text-xs transition-all duration-300 cursor-pointer"
				title={languageTitle}
			>
