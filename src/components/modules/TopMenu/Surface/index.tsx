...
import { GlassSurface } from "@/components/widgets/GlassSurface";

export type ScrolledStyle = "default" | "glass";
...
export function Surface({ isScrolled, scrolledStyle, children }: SurfaceProps) {
