	...
	useEffect(() => {
		...
		function getWebGLContext(targetCanvas: HTMLCanvasElement) {
			...
			if (isWebGL2) {
				...
				supportLinearFiltering = targetGl.getExtension(
					"OES_texture_half_float_linear",
				);
			}
			targetGl.clearColor(0.0, 0.0, 0.0, 1.0);
		...
		function supportRenderTextureFormat(targetGl, internalFormat, format, type) {
			...
			targetGl.texParameteri(
				targetGl.TEXTURE_2D,
				targetGl.TEXTURE_MIN_FILTER,
				targetGl.NEAREST,
			);
			targetGl.texParameteri(
				targetGl.TEXTURE_2D,
				targetGl.TEXTURE_MAG_FILTER,
				targetGl.NEAREST,
			);
			targetGl.texParameteri(
				targetGl.TEXTURE_2D,
				targetGl.TEXTURE_WRAP_S,
				targetGl.CLAMP_TO_EDGE,
			);
			targetGl.texParameteri(
				targetGl.TEXTURE_2D,
				targetGl.TEXTURE_WRAP_T,
				targetGl.CLAMP_TO_EDGE,
			);
			targetGl.texImage2D(
				targetGl.TEXTURE_2D,
